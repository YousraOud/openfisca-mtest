...
install: deps
	...
	@# `make install` installs the editable version of openfisca-mtest.
...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_mtest openfisca_mtest/tests

serve-local: build
	openfisca serve --country-package openfisca_mtest
